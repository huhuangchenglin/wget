		...
		$.ajax({
			...
			success : function(data) {
				...
				if(data.code == 1){
					...
					$("#running_class").html(data.msg+" <a class=\"btn btn-xs btn-danger btn-rounded\" target=\"_blank\" href=\""+data.down+"\">点我下载</a>"+" <a class=\"btn btn-xs btn-danger btn-rounded\" target=\"_blank\" href=\""+data.pr+"\">点我预览</a>");
					$("#running_alert").show();
				}else{
